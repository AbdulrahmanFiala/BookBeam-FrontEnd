...
export const Loans = () => {
  ...
  useEffect(() => {
    const fetchUserCurrentLoans = async () => {
      if (authState && authState.isAuthenticated) {
        const url = `${process.env.REACT_APP_BACKEND_BASE_URL}/books/secure/currentloans`;
  ...
  async function returnBook(bookId: number) {
    const url = `${process.env.REACT_APP_BACKEND_BASE_URL}/books/secure/return/?bookId=${bookId}`;
  ...
  async function renewLoan(bookId: number) {
    const url = `${process.env.REACT_APP_BACKEND_BASE_URL}/books/secure/renew/loan/?bookId=${bookId}`;
